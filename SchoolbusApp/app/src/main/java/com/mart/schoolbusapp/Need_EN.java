...
import com.mart.schoolbusapp.Place_En.Place_En;
...
public class Need_EN extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.need_en);

        final ServerConnecter connecter = new ServerConnecter();
        String re = connecter.connect19("Select_detail_ParentAddress_EN.php",true,true,new Model_Parent_Need_MN(id_parent));
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Need_EN.this);
        ...
        builder.setPositiveButton("ขึ้นรถ", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                String re = connecter.connect18("insert_need_list_numberphone_en.php",true,false,new Model_Need_MN(id_parent,id_address,id_statusNeed,id_number_phone));


                //int id_statusNeed = 1;

               // Intent intent = new Intent(getApplication(),Place_En.class);
        ...
        builder.setNegativeButton("ไม่ขึ้นรถ", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                ServerConnecter connector = new ServerConnecter();
                connector.connect11("insert_need_list_numberphone_en.php", true, false, new Model_StatusNeed(id_statusNeed,id_parent,id_address,id_number_phone));
