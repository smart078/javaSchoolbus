...
/**
 * Created by Mart_ on 3/1/2560.
 */

public class Show_PinMap extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_pinmap);
...
//        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Show_PinMap.this);
        AlertDialog.Builder builder = new AlertDialog.Builder(Show_PinMap.this);
